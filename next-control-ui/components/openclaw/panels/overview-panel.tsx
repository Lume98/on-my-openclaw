          ...
          >
            <Space orientation="vertical" size="middle" style={{ width: "100%" }}>
              ...
              <Descriptions bordered column={1} size="small">
                <Descriptions.Item label="状态">{getStatusBadge(connected)}</Descriptions.Item>
                <Descriptions.Item label="运行时间">
                  <Text strong>{uptime}</Text>
                </Descriptions.Item>
                <Descriptions.Item label="刻度间隔">
                  <Text strong>{tickInterval}</Text>
                </Descriptions.Item>
                <Descriptions.Item label="最后频道刷新">
                  <Text strong>{hello ? "刚刚" : "—"}</Text>
                </Descriptions.Item>
                <Descriptions.Item label="服务端版本">
                  <Text strong>{hello?.server?.version ?? "—"}</Text>
                </Descriptions.Item>
                <Descriptions.Item label="鉴权模式">
                  <Tag color={snapshot?.authMode === "none" ? "default" : "blue"}>
                    {snapshot?.authMode ?? "—"}
                  </Tag>
                </Descriptions.Item>
