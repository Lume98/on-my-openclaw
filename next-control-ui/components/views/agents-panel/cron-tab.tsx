...
export function CronTab({ cronStatus, cronJobsForAgent, _cronError, cronLoading }: CronTabProps) {
  return (
        ...
        <Table
          ...
          columns={[
            { title: "名称", dataIndex: "name", key: "name" },
            {
              title: "状态",
              key: "enabled",
              render: (_: unknown, j: { enabled?: boolean }) =>
                j.enabled !== false ? (
            ...
            },
            {
              title: "下次运行",
              key: "nextRun",
              render: (_: unknown, j: { state?: { nextRunAtMs?: number | null } | null }) =>
