...
import { readConnectErrorDetailCode } from "@/components/openclaw/connect-error-details";
import { GatewayBrowserClient } from "@/components/openclaw/gateway";
import { useSettings } from "@/components/openclaw/providers/settings-provider";
import type { GatewayEventFrame, GatewayHelloOk, PresenceEntry } from "@/components/openclaw/types";
