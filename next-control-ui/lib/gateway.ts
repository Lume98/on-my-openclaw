import { ConnectErrorDetailCodes, readConnectErrorDetailCode } from "@/lib/connect-error-details";
import { clearDeviceAuthToken, loadDeviceAuthToken, storeDeviceAuthToken } from "@/lib/device-auth";
import { loadOrCreateDeviceIdentity, signDevicePayload } from "@/lib/device-identity";
import type { GatewayErrorInfo, GatewayEventFrame, GatewayHelloOk } from "@/lib/types";
